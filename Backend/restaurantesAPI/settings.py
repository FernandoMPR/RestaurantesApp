"""
Django settings for restaurantesAPI project.
...
SECRET_KEY = 'django-insecure-+5ji-%^uh0*e(0wmj93hlysnj3c=(a*0x(8$#w1ubs0bchkq$y'
...
ROOT_URLCONF = 'restaurantesAPI.urls'
...
WSGI_APPLICATION = 'restaurantesAPI.wsgi.application'
